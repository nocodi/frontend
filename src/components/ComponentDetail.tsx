...
const ComponentDetail = ({
  ...
  return (
    <div className="mx-auto h-[calc(100vh-2rem)] max-w-3xl space-y-6 overflow-y-auto bg-base-300 p-4">
      <div className="space-y-4 rounded-2xl bg-base-100 p-6 text-base-300 shadow">
        {loading ?
          <svg
